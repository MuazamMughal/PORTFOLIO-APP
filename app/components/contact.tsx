...
const Contact = () => {
  return (
    <div id="contact">
      ...
      <h1 className="sm:text-4xl text-2xl font-medium title-font mb-4 fornt-bold text-gray-100">
        Contact Us
      </h1>
      ...
      <p className="lg:w-2/3 mx-auto mt-6 text-xl text-gray-300 leading-relaxed ">
        if you wanna contact me simply leave an Email..
      </p>
    </div>
      ...
      <div className="flex flex-wrap -m-2">
        <div className="p-2 w-1/2">
          <div className="relative">
            <label htmlFor="name" className="leading-7 text-lg text-gray-300">
              Name
            </label>
            <input
              type="text"
        ...
        <div className="p-2 w-1/2">
          <div className="relative">
            <label htmlFor="email" className="leading-7 text-lg text-gray-300">
              Email
            </label>
            <input
              type="email"
        ...
        <div className="p-2 w-full">
          <button className="flex  mx-auto text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-400 rounded-xl text-lg">
            Send Mail
          </button>
        </div>
